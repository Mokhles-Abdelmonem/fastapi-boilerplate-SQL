...
from .schemas import RegisterJson, LoginJson
from fastapi_jwt_auth import AuthJWT
from .utils import * 
from .schemas import Token, UserInDB, AccessToken
...
@users_router.get("/hello/", status_code=201)
async def user_register():
    print("hello from user app")
